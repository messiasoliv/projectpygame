...
sound_nave = pygame.mixer.Sound("sounds/nave_destroy.ogg")
sound_tiro = pygame.mixer.Sound("sounds/tiro.ogg")
x = 300
y = 525
...
############################# Módulo Asteroide ################################
def imageAsteroide():
    img = pygame.image.load("images/ast.png").convert()
...
def asteroideDestroyed():
    img = pygame.image.load("images/boomast.jpg").convert()
...
def imageNave():
    img = pygame.image.load("images/nave.png").convert() 
    img = pygame.transform.scale(img, (60,90))
    return img

def naveDestroyed():
    destroyed = pygame.image.load("images/boom.jpg").convert()
    destroyed = pygame.transform.scale(destroyed, (100,100))
    return destroyed

#######################################
def imageTiro():
    img = pygame.image.load("images/tiro.png").convert()
