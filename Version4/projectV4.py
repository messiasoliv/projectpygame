...
############################# Módulo Asteroide ################################    
def cria_asteroide():
    my_image = pygame.image.load("ast.png").convert()
    my_image = pygame.transform.scale(my_image, (40,40))
    return {
        'surface': my_image,
...
def nave():
    my_nave = pygame.image.load("nave.png").convert() 
    my_nave = pygame.transform.scale(my_nave, (60,60))
